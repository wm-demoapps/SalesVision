...
App.weeklyTarget = 25000;
App.currentDate = moment().format('YYYY-MM-DD');

App.QVgetsalesachievedandtargetonSuccess = function(variable, data) {
    var achieved = App.Variables.QVgetsalesachievedandtarget.dataSet[0].achieved;

    var data1 = [{
        "name": "Sales target",
        "dataValue": (1000000 - achieved < 0 ? 0 : 1000000 - achieved)
    }, {
        "name": "Target achieved",
        "dataValue": achieved
    }];
    App.Variables.SVfordonut.setData(data1);
